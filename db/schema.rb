...
ActiveRecord::Schema.define(version: 2020_08_17_015115) do
  ...
  create_table "accounts_employees", id: false, force: :cascade do |t|
    ...
    t.decimal "balance"
    t.index ["account_id"], name: "index_accounts_employees_on_account_id"
    t.index ["employee_id"], name: "index_accounts_employees_on_employee_id"
  end
